...
\begin{document}
	...
	\begin{frame}{Received Signal Formulation}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\linewidth]{"placeholder-mpc-arrival-diagram.png"}
	...
	\begin{frame}{Condition for Narrowband}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{"placeholder-narrowband-condition.png"}
	...
	\begin{frame}{Condition for Wideband}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{"placeholder-wideband-condition.png"}
	...
	\begin{frame}{Visualizing the Taps}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.9\linewidth]{"placeholder-tdl-grouping.png"}
	...
	\begin{frame}{The Rayleigh Distribution}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\linewidth]{"placeholder-rayleigh-pdf.png"}
	...
	\begin{frame}{The Rician Distribution}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\linewidth]{"placeholder-rician-pdf.png"}
	...
	\begin{frame}{The Power Delay Profile (continued)}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\linewidth]{"placeholder-pdp-example.png"}
