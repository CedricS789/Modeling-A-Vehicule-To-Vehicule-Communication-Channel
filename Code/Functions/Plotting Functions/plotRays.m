...
%   K                    - Maximum number of reflections, used for the plot title.
    ...
    title(ax, sprintf('Ray Tracing with up to %d Reflections', K));                       % Set a descriptive title for the plot.
    ...
    % 'DisplayName' (e.g., one "2-Refl" entry, even if 10 such rays were plotted).
