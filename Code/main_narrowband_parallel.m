...
fprintf('   Distance simulation took %.2f seconds.\n', toc);
...
% [n_pl, sigma_L, PL_d0] = pathLoss(distances_domain, P_RX_total_dBm_vs_dist, params);
...
function updateWaitbar(h_bar, total_iterations, title_str)
    ...
    waitbar(fraction_done, h_bar, sprintf('%s  %.0f%%', title_str, fraction_done * 100));
end